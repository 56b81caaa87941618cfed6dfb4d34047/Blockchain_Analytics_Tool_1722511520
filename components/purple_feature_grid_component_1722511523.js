    ...
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            <div id="feature-1-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-1-title-container"><h4 id="feature-1-title" class="flex-1 text-slate-50 font-medium">Real-Time Blockchain Monitoring</h4></div>
            </div>
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm">Stay ahead of the curve with our advanced blockchain monitoring system. Get instant alerts and insights on new transactions, blocks, and activities across multiple blockchain networks.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container"><h4 id="feature-2-title" class="flex-1 text-slate-50 font-medium">Comprehensive Data Analysis</h4></div>
            </div>
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm">Leverage our powerful analytical tools to gain deep insights into blockchain data. Uncover valuable patterns, trends, and anomalies that drive informed decision-making.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm">Ensure the security and integrity of your smart contracts with our robust auditing capabilities. Identify vulnerabilities, optimize gas usage, and ensure compliance.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm">Tailor your experience with customizable dashboards that provide a unified view of all your blockchain activities. Visualize data in a way that resonates with your unique needs.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm">Easily connect our platform with your existing systems and tools. Our open APIs and SDKs enable smooth integration, allowing you to streamline your workflows.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm">Trust that your blockchain data is in safe hands with our industry-leading security measures. We employ multiple layers of protection, including encryption, access controls, and regular audits.</p></div>
        </div>
    </div>`,
        data() {
            return {
